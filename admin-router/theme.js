...
themeRouter.post('/update-theme/:themeId',  authPage('admin', 'teacher'),    themeController.updateTheme) // update theme 
themeRouter.post('/delete-theme/:themeId',  authPage('admin', 'teacher'),    themeController.deleteTheme) //  delete them 
